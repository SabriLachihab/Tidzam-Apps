...
public class WikiBirdsStatActvity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        namespecies = StatsBirdsActivity.getInstence().getNomspecie();
        name.setText( namespecies.replace( "_", " " ) );
        sensors = SplashScreen.getInstence().getListsensors();
        String url = "https://tidzam.media.mit.edu/static/img/birds-" + namespecies + ".png";
        Log.i( "debug", url );
        ...
        Animation a = AnimationUtils.loadAnimation( WikiBirdsStatActvity.this, R.anim.downappear );
        Animation b = AnimationUtils.loadAnimation( WikiBirdsStatActvity.this, R.anim.leftappear );
        Animation c = AnimationUtils.loadAnimation( WikiBirdsStatActvity.this, R.anim.rightappear );
        a.reset();
        b.reset();
        c.reset();
        info.clearAnimation();
    ...
    private void PrintGraph(ArrayList<StatsByMonth> links) {
        ...
        graph.setOnChartValueSelectedListener( new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, Highlight h) {
                final AlertDialog.Builder info = new AlertDialog.Builder( WikiBirdsStatActvity.this );
                String message = "";
                for (int i = 0; i < months.size(); i++) {
