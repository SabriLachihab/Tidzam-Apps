...
public class WikiStatsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        namespecies = StatsActivity.getInstance().getNomspecie();
        ...
        Animation a = AnimationUtils.loadAnimation( WikiStatsActivity.this, R.anim.downappear );
        Animation b = AnimationUtils.loadAnimation( WikiStatsActivity.this, R.anim.leftappear );
        Animation c = AnimationUtils.loadAnimation( WikiStatsActivity.this, R.anim.rightappear );
        a.reset();
        b.reset();
        c.reset();
        info.clearAnimation();
    ...
    private void PrintGraph(ArrayList<StatsByMonth> links) {
        ...
        graph.setOnChartValueSelectedListener( new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, Highlight h) {
                final AlertDialog.Builder info = new AlertDialog.Builder( WikiStatsActivity.this );
                String message = "";
                for (int i = 0; i < months.size(); i++) {
