...
public class WikiSampleBirds extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        namespecies = SampleDatabaseBirdsActivity.getInstence().getBirds_name();
        graph = (BarChart) findViewById( R.id.barmonth );
        String val[] = namespecies.split( "-" );
        name.setText( val[1].replace( "_", " " ) );
        ...
        Animation a = AnimationUtils.loadAnimation( WikiSampleBirds.this, R.anim.downappear );
        Animation b = AnimationUtils.loadAnimation( WikiSampleBirds.this, R.anim.leftappear );
        Animation c = AnimationUtils.loadAnimation( WikiSampleBirds.this, R.anim.rightappear );
        a.reset();
        b.reset();
        c.reset();
    ...
    public void WikipediaExtract(String specie) {
        ...
        if (specie.contains( "black_capped_chickadee" )) {
            specie = "black_capped_chickadee";
        }
        if (specie.contains( "red_winged_blackbird" )) {
    ...
    private void PrintGraph(ArrayList<StatsByMonth> links) {
        ...
        graph.setOnChartValueSelectedListener( new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, Highlight h) {
                AlertDialog.Builder info = new AlertDialog.Builder( WikiSampleBirds.this );
                String message = "";
                for (int i = 0; i < months.size(); i++) {
