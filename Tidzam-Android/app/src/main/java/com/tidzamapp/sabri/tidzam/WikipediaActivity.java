...
public class WikipediaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        namespecies=StatBirdsSpecies.getInstence().getBirds_name();
        ...
        Animation a = AnimationUtils.loadAnimation(WikipediaActivity.this, R.anim.downappear);
        Animation b = AnimationUtils.loadAnimation(WikipediaActivity.this, R.anim.leftappear);
        Animation c = AnimationUtils.loadAnimation(WikipediaActivity.this, R.anim.rightappear);
        a.reset();
        b.reset();
        c.reset();
    ...
    private void PrintGraph(ArrayList<StatsByMonth> links) {
        ...
        graph.setOnChartValueSelectedListener( new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, Highlight h) {
                AlertDialog.Builder info = new AlertDialog.Builder( WikipediaActivity.this);
                String message = "";
                for(int i=0;i<months.size();i++)
                {
