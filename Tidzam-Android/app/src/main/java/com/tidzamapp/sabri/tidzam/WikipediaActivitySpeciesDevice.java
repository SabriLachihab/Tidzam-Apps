...
/**
 * Created by Sabri on 14/12/2017.
 */

public class WikipediaActivitySpeciesDevice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        namespecies= StatsDeviceSpecies.getStatsDeviceSpecies().getSpecie();
        ...
        Animation a = AnimationUtils.loadAnimation(WikipediaActivitySpeciesDevice.this, R.anim.downappear);
        Animation b = AnimationUtils.loadAnimation(WikipediaActivitySpeciesDevice.this, R.anim.leftappear);
        Animation c = AnimationUtils.loadAnimation(WikipediaActivitySpeciesDevice.this, R.anim.rightappear);
        a.reset();
        b.reset();
        c.reset();
        info.clearAnimation();
    ...
    private void PrintGraph(ArrayList<StatsByMonth> links) {
        ...
        graph.setOnChartValueSelectedListener( new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, Highlight h) {
                AlertDialog.Builder info = new AlertDialog.Builder( WikipediaActivitySpeciesDevice.this);
                String message = "";
                for(int i=0;i<months.size();i++)
                {
